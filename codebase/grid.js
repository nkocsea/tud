...
function getContentHeight(renderConfig, isSticky, wrapperSizes) {
    ...
    if (renderConfig.splitAt && lessByHeight) {
        return (renderConfig.$totalHeight +
            (isFooter ? renderConfig.footerHeight : null) +
...
function getFixedCols(renderConfig, layout) {
    ...
    var fixedColsHeight = (layout.sticky ? layout.gridBodyHeight : layout.gridBodyHeight + renderConfig.headerHeight) -
        scrollBarWidth;
